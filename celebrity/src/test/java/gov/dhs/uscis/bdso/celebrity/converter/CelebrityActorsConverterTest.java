...
public class CelebrityActorsConverterTest {
	Mapper mapper = Mockito.mock(Mapper.class);
	
    // @InjectMocks
    CelebrityActorsConverter celebrityActorsConverter = new CelebrityActorsConverter();
	...
	public void testConvertFrom() throws Exception{
        ...
        movieCast.setActorId(celebrityId);
        Set<MovieCast> movieCastSet = new HashSet<>();
        movieCastSet.add(movieCast);
